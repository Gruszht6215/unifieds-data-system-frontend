...
import { deleteClusterByClusterIdDispatch } from '../../redux/slices/clusterSlice'
...
export default function DeleteClusterModal({ isOpen, closeModal, cluster }: Props) {
    const dispatch = useAppDispatch()
    let completeButtonRef = useRef(null)

    const confirmButtonHandler = async () => {
        dispatch(deleteClusterByClusterIdDispatch(cluster.id))
        closeModal();
    }
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            All attached tags will be lost.
                                        </p>
                                    </div>
